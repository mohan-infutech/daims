...
$(document).ready(function() {
    // When a button with class 'pq-filter-btn' is clicked
    $('.pq-filter-btn').click(function() {
        // Remove 'active' class from all buttons with class 'pq-filter-btn'
        $('.pq-filter-btn').removeClass('active');
        ...
        if (filter === 'All') {
            // If 'All' button is clicked, show all items
            $('.grid-item').removeClass('d-none');
        } else {
            // Hide all items not in the selected group
            $('.grid-item').addClass('d-none');
            $('.grid-item[data-filter="' + filter + '"]').removeClass('d-none');
        }
    });
});
